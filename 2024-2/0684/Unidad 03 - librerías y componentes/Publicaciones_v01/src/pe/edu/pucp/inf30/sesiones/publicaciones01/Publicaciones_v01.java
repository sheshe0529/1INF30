...
import pe.edu.pucp.inf30.sesiones.publicaciones01.publicaciones.estandardAPA.Tesis;
import pe.edu.pucp.inf30.sesiones.publicaciones01.publicaciones.estandardAPA.Libro;
import pe.edu.pucp.inf30.sesiones.publicaciones01.publicaciones.estandardAPA.Articulo;
...
public class Publicaciones_v01 {
    ...
    public static void main(String[] args) {
        ...
        publicaciones[0] = new pe.edu.pucp.inf30.sesiones.publicaciones01.publicaciones.estandardIEEE.Articulo("A relational model of data for large shared data banks", "Codd, Edgar Frank", 1970, "Communications of the ACM", 13, 6, "junio");
